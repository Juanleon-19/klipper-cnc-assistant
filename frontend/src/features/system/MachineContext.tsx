...
export type MachineAction = "connect" | "disconnect" | "diagnostic" | "reconnect-arduino" | "initialize" | "manual-on" | "manual-off" | "probe-request" | "probe-confirm" | "tool-change-position" | "cancel" | "safe-stop" | "emergency" | "refresh";
