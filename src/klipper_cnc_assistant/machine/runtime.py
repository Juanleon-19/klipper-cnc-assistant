...
class MachineRuntime:
    ...
    def update_machine_settings(self, payload: dict[str, Any]) -> dict[str, float]:
        ...
        if ownership["active"] or ownership["recovery_pending"]:
            raise MachineRuntimeError("La configuración física está bloqueada por ownership o recuperación pendiente.")
    ...
    def move_to_tool_change_position(self, tool_change_profile: str = "standard", *, permit: PhysicalPermit | None = None) -> dict[str, Any]:
        ...
        try:
            ...
            self._move_absolute(
                x=target_x, y=target_y, label="tool_change_xy",
    ...
    def _move_absolute(
        ...
        label: str, feed_mm_min: float = AUXILIARY_DEFAULT_TRAVEL_FEED_MM_MIN,
        coordinate_frame: str = "live_position", source_context=None, dependencies=(),
    ) -> None:
        self._raise_if_cancelled()
